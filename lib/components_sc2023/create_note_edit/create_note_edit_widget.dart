...
class _CreateNoteEditWidgetState extends State<CreateNoteEditWidget> {
  ...
  void initState() {
    ...
    _model.courseNameController ??= TextEditingController(text: widget.title);
  }
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CREATE_NOTE_EDIT_COMP_DELETE_BTN_ON_TAP');
                                  logFirebaseEvent('Button_backend_call');
                                  await widget.courseIndexRef!.delete();
                          ...
                          child: Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CREATE_NOTE_EDIT_COMP_CANCEL_BTN_ON_TAP');
                                  logFirebaseEvent('Button_navigate_back');
                                  Navigator.pop(context);
                                },
                                text: 'Cancel',
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CREATE_NOTE_EDIT_CREATE_NOTE_BTN_ON_TAP');
                                  logFirebaseEvent('Button_backend_call');

                                  final courseIndexUpdateData =
                                      createCourseIndexRecordData(
                                    title: _model.courseNameController.text,
                                  );
