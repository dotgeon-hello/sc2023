...
import '/pages_default/login/login_widget.dart';
import '/pages_default/register/register_widget.dart';
...
class _SplashScreenCopyWidgetState extends State<SplashScreenCopyWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'SplashScreenCopy'});
    setupAnimations(
                          ...
                          children: [
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'SPLASH_SCREEN_COPY_REGISTER_BTN_ON_TAP');
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'SPLASH_SCREEN_COPY_PAGE_LOGIN_BTN_ON_TAP');
                                logFirebaseEvent('Button_navigate_to');
                                await Navigator.push(
                                  context,
                                  MaterialPageRoute(
